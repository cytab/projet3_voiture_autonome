...
if("TRUE" STREQUAL "TRUE")
  set(teleop_tools_msgs_SOURCE_PREFIX /home/cyrille/catkin_ws/src/teleop_tools/teleop_tools_msgs)
  set(teleop_tools_msgs_DEVEL_PREFIX /home/cyrille/catkin_ws/devel)
  ...
  set(teleop_tools_msgs_INSTALL_PREFIX /home/cyrille/catkin_ws/install)
...
if(NOT "/home/cyrille/catkin_ws/devel/include " STREQUAL " ")
  set(teleop_tools_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/cyrille/catkin_ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'teleop_tools_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cyrille/catkin_ws/src/teleop_tools/teleop_tools_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT teleop_tools_msgs_NUM_DUMMY_TARGETS)
      set(teleop_tools_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::teleop_tools_msgs::wrapped-linker-option${teleop_tools_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR teleop_tools_msgs_NUM_DUMMY_TARGETS "${teleop_tools_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::teleop_tools_msgs::wrapped-linker-option${teleop_tools_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND teleop_tools_msgs_LIBRARIES "${interface_target_name}")
